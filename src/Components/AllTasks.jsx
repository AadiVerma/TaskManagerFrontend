   ...
   const dates=[1,2,3,4,5];
    return (
        <div className="w-[85%] text-white bg-[#212121] rounded-lg h-fit p-5 overflow-hidden">
            <h1 className="text-2xl font-newfont font-bold">All Tasks</h1>
            ...
            <div className="flex justify-between  mt-10">
                <h2 className="flex text-3xl font-newfont font-bold">May, 10</h2>
            ...
            <div className="pt-4 pl-4 rounded-xl flex flex-wrap gap-4">
                {data && data.map((d) => (
